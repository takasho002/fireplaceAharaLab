...
def printAllRogueCards():
	...
	for card in collection:
		...
		if '相手のデッキに' in dscrpt and  '混ぜる' in dscrpt:
...
#[TRL_524][シールドブレイカー](<b>雄叫び:</b><b>挑発</b>を持つ敵のミニオン1体を<b>沈黙</b>させる。)
	if '自分の'in dscrpt and '手札に追加する' in dscrpt:
