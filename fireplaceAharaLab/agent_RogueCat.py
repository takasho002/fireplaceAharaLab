...
#[AT_031][スリ](このミニオンがヒーローを攻撃する度、自分の手札に「コイン」1枚を追加する。)
#[AT_032][闇商人]([x]<b>雄叫び:</b>味方に海賊がいる場合___+1/+1を獲得する。)
#[AT_033][強盗]([x]<i>相手のクラスの</i>ランダムなカード2枚を自分の手札に追加する。)
#[AT_034][毒仕込みの刃](自分のヒーローパワーはこの武器と置き換わる代わりに、この武器に攻撃力+1を付与する。)
#[AT_035][土蜘蛛]([x]相手のデッキに「待ち伏せ！」3枚を混ぜる。「待ち伏せ！」が引かれた際自分の陣地に4/4の_____ネルビアンを1体召喚する。)
#[AT_036][アヌバラク]([x]<b>断末魔:</b>このカードを自分の手札に戻し4/4のネルビアン1体を[x]召喚する。)
#[AT_070][空賊船長クラッグ](<b>突撃ィィィィ</b>味方の海賊1体につきコストが（1）減る。)
#[AT_080][守備隊司令官](自分のヒーローパワーを1ターンに2回まで[x]使用できる。)
#[AT_082][下っ端従騎士](<b>激励:</b> 攻撃力+1を獲得する。)
#[AT_083][ドラゴンホーク騎兵]([x]<b>激励:</b>このターンの間____<b>疾風</b>を獲得する。)
#[AT_084][槍持ち](<b>雄叫び:</b> 味方のミニオン1体に攻撃力+2を付与する。)
#[AT_085][湖の乙女](自分のヒーローパワーの[x]コストは（1）。)
#[AT_086][妨害工作員]([x]<b>雄叫び:</b> 次のターン、相手のヒーローパワーの____コストが（5）増える。)
#[AT_087][アージェントの騎兵](<b>突撃:</b><b>聖なる盾</b>)
#[AT_088][モゴールの勇者](50%の確率で、指定していない敵を攻撃する。)
...
#[AT_094][火炎ジャグラー](<b>雄叫び:</b>ランダムな敵1体に1ダメージを与える。)
#[AT_095][静寂の騎士](<b>隠れ身</b><b>聖なる盾</b>)
#[AT_096][ゼンマイ仕掛けの騎士]([x]<b>雄叫び:</b> 味方のメカ1体に__+1/+1を付与する。)
#[AT_097][トーナメント参加者](<b>挑発</b>)
#[AT_098][大道芸の呪文喰い]([x]<b>雄叫び:</b>相手のヒーローパワーをコピーする。)
#[AT_099][コドー騎兵]([x]<b>激励:</b>3/5の戦闘コドーを1体召喚する。)
#[AT_100][シルバーハンドの執政](<b>激励:</b> 1/1のシルバーハンド新兵を1体召喚する。)
#[AT_101][決闘士]()
#[AT_102][捕獲されたヨルムンガー]()
#[AT_103][北海のクラーケン](<b>雄叫び:</b> 4ダメージを与える。)
#[AT_105][傷を負ったクヴァルディル](<b>雄叫び:</b> このミニオンに3ダメージを与える。)
...
#[AT_111][スナック売り](<b>雄叫び:</b>各ヒーローの体力を#4回復する。)
...
#[AT_120][霜の巨人](この対戦で自分がヒーローパワーを使用した回数につきコストが（1）減る。)
...
#[AT_124][ボルフ・ラムシールド]([x]自分のヒーローがダメージを受ける度、このミニオンが身代わりとなって___そのダメージを受ける。)
#[AT_125][アイスハウル](<b>突撃:</b>ヒーローを攻撃できない。)
...
#[AT_131][エイディス・ダークベイン]([x]<b>自分</b>がこのミニオンに対して呪文を使用する度ランダムな敵に_____3ダメージを与える。)
...
#[BOT_087][学術スパイ]([x]相手のクラスのカード10枚を__自分のデッキに混ぜる。それらのコストは（1）になる。)
#[BOT_098][パワー切れのモーラー]([x]このターンに自分が呪文を使用した___場合のみ攻撃できる。)
#[BOT_102][スパーク・ドリル]([x]<b>急襲</b><b>断末魔:</b><b>急襲</b>を持つ1/1の「スパーク」2体を自分の手札に追加する。)
#[BOT_107][ミサイルランチャー]([x]<b>超電磁</b>自分のターンの終了時自身を除く全てのキャラクターに_1ダメージを与える。)
#[BOT_242][マイラの不安定元素]([x]自分のデッキの残りのカードを__全て引く。)
...
#[BOT_280][幻像術師]([x]相手がミニオンを手札から使用した後そのミニオンの1/1のコピーを1体召喚する。)
...
#[BOT_559][改造エレク]([x]自分がカードをデッキに混ぜる度そのコピーを1枚__余分に混ぜる。)
#[BOT_562][カッパーテイルモドキ]([x]<b>雄叫び:</b>次の自分のターンまで__<b>隠れ身</b>を獲得する。)
#[BOT_563][ウォーギア](<b>超電磁</b>)
...
#[BOT_914][ワンダフル・ウィズバン]([x]ウィズバンのワンダフル・デッキの1つを使って対戦を開始する。)
#[BRM_007][集合の合図](任意のミニオン1体を選択する。そのコピー3枚を自分のデッキに混ぜる。)
#[BRM_008][ダークアイアン・スカルカー]([x]<b>雄叫び:</b>ダメージを受けていない敵のミニオン全てに____2ダメージを与える。)
#[BRM_019][ぐったりガブ呑み亭の常連]([x]このミニオンがダメージを受けて生き延びた後「ぐったりガブ呑み亭の常連」をもう1体召喚する。)
#[BRM_020][ドラゴンキン・ソーサラー]([x]<b>自分</b>がこのミニオンに対して呪文を使用する度+1/+1を獲得する。)
#[BRM_022][ドラゴンの卵](このミニオンがダメージを受ける度2/1のチビドラゴン1体を召喚する。)
#[BRM_024][ドラコニッド・クラッシャー]([x]<b>雄叫び:</b> 相手の体力が15以下の場合____+3/+3を獲得する。)
#[BRM_025][ヴォルカニック・ドレイク](このターンに死亡したミニオン1体につき__コストが（1）減る。)
#[BRM_026][腹ペコのドラゴン](<b>雄叫び:</b> ランダムなコスト1のミニオン1体を相手の陣地に召喚する。)
#[BRM_027][筆頭家老エグゼクタス]([x]<b>断末魔:</b>自分のヒーローを「炎の王ラグナロス」と置き換える。)
#[BRM_028][ソーリサン皇帝](自分のターンの終了時自分の手札のコストを（1）減らす。)
...
#[BRM_031][クロマガス](自分がカードを引く度そのカードのコピー1枚を自分の手札に追加する。)
...
#[BT_156][封印されしヴァイルフィーンド]([x]2ターンの間、<b>休眠状態</b>。<b>急襲</b>)
...
#[BT_190][フエル・オ・トロン]([x]自分のターンの終了時隣接するミニオン1体をこれのコピーに変身させる。)
#[BT_255][ケルサス・サンストライダー]([x]毎ターン、自分が使用する呪文のコストは3回目ごとに（0）になる。)
...
#[BT_721][飛び散る腐汁]([x]自分のターンの終了時このミニオンと同じ攻撃力・体力の腐汁を1体召喚する。)
...
#[BT_727][結魂のアッシュタン]([x]このミニオンがダメージを受ける度自分のヒーローも等しい___ダメージを受ける。)
...
#[BT_731][胞蝕スポアリング]([x]これがミニオンにダメージを与えた後、そのミニオンを「胞蝕スポアリング」に変身させる。)
#[BT_732][鋼拾いのシヴァーラ]([x]<b>雄叫び:</b>合計6ダメージを自身を除くミニオンに____ランダムに振り分ける。_)
#[BT_733][モアーグの加工師]([x]全てのミニオンは呪文から2倍の___ダメージを受ける。)
#[BT_734][奈落の大悪鬼]([x]ヒーローを攻撃できない。)
...
#[CFM_025][マキアゲール・ド・ロボー](このミニオンがミニオンを攻撃して生き残った場合カードを1枚引く。)
#[CFM_039][路上のトリックスター](<b>呪文ダメージ+1</b>)
#[CFM_060][レッド・マナ・ワーム]([x]自分が呪文を使う度攻撃力+2を獲得する。)
#[CFM_063][妙ちくりんな薬剤師]([x]<b>雄叫び:</b> ミニオン1体の攻撃力と体力を入れ替える。)
#[CFM_064][肥え太った有力者]([x]このカードが自分の手札にある間、自分が<b>雄叫び</b>を持つミニオンを召喚する度+1/+1を獲得する。)
#[CFM_067][ホーゼンの治療師]([x]<b>雄叫び:</b> ミニオン1体の体力を____上限まで回復する。)
#[CFM_095][穴掘りイタチ]([x]<b>断末魔:</b> このミニオンを相手のデッキに混ぜる。)
#[CFM_120][超うざい調剤師]([x]<b>断末魔:</b>各ヒーローの体力を#4回復する。)
#[CFM_321][グライムストリートの情報屋]([x]<b>雄叫び:</b>ハンター、パラディンまたはウォリアーの　カードを1枚<b>発見</b>する。)
#[CFM_325][ちんけなバッカニーア]([x]自分のヒーローが武器を装備している場合攻撃力+2を得る。)
#[CFM_328][闘技プロモーター](<b>雄叫び:</b> 味方に体力6以上のミニオンがいる場合カードを2枚引く。)
#[CFM_341][サリー巡査部長](<b>断末魔:</b>敵のミニオン全てにこのミニオンの攻撃力に等しいダメージを与える。)
#[CFM_342][幸運のお守りのバッカニーア]([x]<b>雄叫び:</b>自分の武器の攻撃力が3以上ある場合____+4/+4を獲得する。)
#[CFM_344][飛刀手流忍者・六丸]([x]<b>隠れ身</b>このミニオンの攻撃でミニオンが 死亡した時、自分のデッキからマーロックを2体召喚する。)
#[CFM_609][フェル・オーク・ソウルフィーンド]([x]自分のターンの開始時このミニオンに___2ダメージを与える。)
#[CFM_619][カバールの薬剤師]([x]<b>雄叫び:</b>ランダムなポーション1枚を自分の手札に追加する。)
#[CFM_621][カザカス]([x]<b>雄叫び:</b>自分のデッキに重複するカードがない場合_____即興呪文を1つ作成する。)
#[CFM_630][偽造コイン]([x]このターンの間のみマナクリスタルを1つ獲得する。)
#[CFM_634][蓮華凶手]([x]<b>隠れ身</b>このミニオンが攻撃してミニオンを倒す度に　<b>隠れ身</b>を獲得する。)
#[CFM_636][シャドウ・レイジャー](<b>隠れ身</b>)
#[CFM_637][海賊パッチーズ]([x]自分が海賊を手札から使用した後自分のデッキからこの____ミニオンを召喚する。)
#[CFM_646][裏町のレプラノーム]([x]<b>断末魔:</b>敵のヒーローに____2ダメージを与える。)
#[CFM_647][ブロウギル・スナイパー]([x]<b>雄叫び:</b> 1ダメージを与える。)
#[CFM_648][暗黒街の大物](<b>雄叫び:</b>6/6のオーガを1体召喚する。)
#[CFM_649][カバールの飛脚]([x]<b>雄叫び:</b>メイジ、プリーストまたはウォーロックの　カードを1枚<b>発見</b>する。)
#[CFM_651][ナーガの海賊]([x]<b>雄叫び:</b>自分の武器に___攻撃力+1を付与する。)
#[CFM_652][二流の強面]([x]<b>挑発</b>相手の陣地に3体以上のミニオンがいる場合_____コストが（2）減る。)
#[CFM_653][日雇い護衛](<b>挑発</b>)
#[CFM_654][陽気なバーテン](自分のターンの終了時自分のヒーローの体力を#1回復する。)
...
#[TRL_564][モジョー使いジヒィ](<b>雄叫び:</b>各プレイヤーのマナクリスタルを5つにする。)
...
#[ULD_003][偉大なるゼフリス](<b>雄叫び:</b>自分のデッキに重複するカードがない場合「勝利のカード」の願いを叶える。)
#[ULD_157][クエスト中の探検家]([x]<b>雄叫び:</b>自分が<b>クエスト</b>中の場合__カードを1枚引く。)
...
#[ULD_180][日射病の子分]([x]自分のターンの開始時50%の確率で眠る。)
#[ULD_182][唾を吐くラクダ]([x]自分のターンの終了時自身を除くランダムな味方のミニオン1体に____1ダメージを与える。_)
#[ULD_183][アヌビサス・ウォーブリンガー](<b>断末魔:</b>自分の手札のミニオン全てに+3/+3を付与する。)
#[ULD_184][コボルトのサンドトルーパー]([x]<b>断末魔:</b>敵のヒーローに___3ダメージを与える。)
#[ULD_185][寺院の狂戦士](<b>蘇り</b>ダメージを受けている間は__攻撃力+2を得る。)
#[ULD_186][ファラオの愛猫]([x]<b>雄叫び:</b><b>蘇り</b>を持つランダムなミニオン1体を自分の__手札に追加する。)
#[ULD_188][黄金スカラベ](<b>雄叫び:</b>コスト4のカード1枚を<b>発見</b>する。)
#[ULD_189][無貌の潜むもの]([x]<b>挑発</b>、<b>雄叫び:</b>このミニオンの体力を2倍にする。)
#[ULD_190][ピット・クロコリスク](<b>雄叫び:</b>5ダメージを与える。)
#[ULD_191][笑顔の相棒]([x]<b>雄叫び:</b>味方のミニオン1体に___体力+2を付与する。)
#[ULD_193][動くモニュメント](<b>挑発</b>)
#[ULD_194][荒れ地のスコーピッド](<b>猛毒</b>)
#[ULD_196][ネフェルセトの儀式官](<b>雄叫び:</b>隣接するミニオンの体力を上限まで回復する。)
#[ULD_197][流砂のエレメンタル]([x]<b>雄叫び:</b>このターンの間敵のミニオン全てに____攻撃力-2を付与する。)
#[ULD_198][うつろう蜃気楼]([x]<b>挑発</b>自分のターンの開始時このミニオンを____自分のデッキに混ぜる。)
#[ULD_205][ロウソク盗リャー](<b>蘇り</b>)
#[ULD_208][カルトゥートの守護者]([x]<b>挑発</b>、<b>蘇り</b><b>断末魔:</b>自分のヒーローの_____体力を#3回復する。)
#[ULD_209][ヴァルペラの悪党]([x]<b>雄叫び:</b>呪文1つを<b>発見</b>するかミステリーチャンスに賭ける。)
#[ULD_214][太っ腹ミイラ]([x]<b>蘇り</b>相手のカードのコストが（1）少なくなる。)
#[ULD_215][包帯ゴーレム]([x]<b>蘇り</b>自分のターンの終了時<b>挑発</b>を持つ1/1の「スカラベ」を1体召喚する。)
#[ULD_229][トラブルメーカー]([x]<b>雄叫び:</b>自分のデッキと相手のデッキの一番上の____カードを交換する。)
...
#[ULD_286][死の影]([x]ミニオン1体を選択する。引かれた際そのコピー1体を召喚する「影」3枚を自分のデッキに混ぜる。)
#[ULD_288][斂葬のアンカ]([x]<b>雄叫び:</b>自分の手札の<b>断末魔</b>を持つ各ミニオンをそれぞれコスト（1）の1/1に変える。)
#[ULD_289][フィッシュフリンガー]([x]<b>雄叫び:</b>各プレイヤーの手札にランダムなマーロック1体を追加する。)
#[ULD_290][歴史愛好家]([x]自分がミニオンを手札から使用する度自分の手札のランダムなミニオン1体に+1/+1を付与する。)
#[ULD_304][ファオリス王]([x]<b>雄叫び:</b>自分の手札の呪文1枚ごとに同コストのランダムな___ミニオンを1体召喚する。)
#[ULD_309][ドワーフの考古学者]([x]自分がカードを<b>発見</b>した後そのコストを（1）減らす。)
#[ULD_326][バザールぶんどリャー]([x]<b>クエスト:</b>他のクラスのカード4枚を手札に追加する。<b>報酬:</b>_古代の刃)
#[ULD_327][バザール強盗]([x]<b>急襲</b>、<b>雄叫び:</b>他のクラスのランダムなミニオン1体を自分の手札に追加する。)
#[ULD_328][巧みな変装]([x]他のクラスのランダムな呪文2枚を自分の___手札に追加する。)
#[ULD_450][ヴァイルフィーンド](<b>生命奪取</b>)
#[ULD_702][埋葬マシーン]([x]相手がミニオンを手札から使用した後そのミニオンに<b>蘇り</b>を付与する。)
#[ULD_703][砂漠のオベリスク]([x]自分のターンの終了時自分の陣地にこのミニオンが3体以上いる場合ランダムな敵1体に___5ダメージを与える。)
#[ULD_705][魔古の狂信者]([x]<b>雄叫び:</b>自分の陣地が「魔古の狂信者」で一杯の場合それら全てを生贄にして「大番人ラー」を召喚する。)
#[ULD_706][バレバレの囮]([x]<b>断末魔:</b>各プレイヤーは手札の最もコストが低いミニオンを1体召喚する。)
#[ULD_712][昆虫採集家](<b>雄叫び:</b><b>急襲</b>を持つ1/1の「イナゴ」を1体召喚する。)
#[ULD_715][狂気の災厄](各プレイヤーは<b>猛毒</b>を持つ2/2のナイフを装備する。)
#[ULD_719][サバクウサギ](<b>雄叫び:</b>1/1の「サバクウサギ」を2体召喚する。)
#[ULD_721][月の巨像](<b>聖なる盾</b>、<b>蘇り</b>)
#[ULD_723][ミーラック](<b>蘇り</b>)
#[ULD_727][包帯巻き職人]([x]<b>雄叫び:</b>この対戦で死亡した味方のミニオンを1体<b>発見</b>し、それを自分のデッキに混ぜる。)
#[UNG_001][プテロダックスのヒナ](<b>雄叫び:</b>___<b>適応</b>する。)
#[UNG_002][ヴォルカノサウルス](<b>雄叫び:</b><b>適応</b>し、その後<b>適応</b>する。)
#[UNG_009][ラヴァサウルスのチビ](<b>雄叫び:</b>このミニオンを除いて味方に2体以上のミニオンがいる場合<b>適応</b>する。)
#[UNG_010][満腹のスレッシャドン]([x]<b>断末魔:</b>1/1のマーロックを3体召喚する。)
#[UNG_057][刃花の連弾]([x]「レイザーペタル（1ダメージを与える）」2枚を自分の手札に追加する。)
#[UNG_058][レイザーペタル・ラッシャー]([x]<b>雄叫び:</b>「レイザーペタル（1ダメージを与える）」1枚を自分の手札に追加する。)
#[UNG_060][擬態の卵](カードを1枚引き、さらにそのコピー1枚を自分の手札に追加する。)
#[UNG_061][黒曜石の破片]([x]この対戦で使用した他のクラスのカード1枚につきコストが（1）減る。)
...
#[UNG_067][地底の大洞窟](<b>クエスト:</b>同じ名前のミニオンを5体手札から使用する。<b>報酬:</b> クリスタルコア)
...
#[UNG_073][ロックプール・ハンター]([x]<b>雄叫び:</b>味方のマーロック1体に+1/+1を付与する。)
#[UNG_075][獰猛なヒナ]([x]このミニオンはヒーローを攻撃した後<b>適応</b>する。)
#[UNG_076][卵泥棒]([x]<b>断末魔:</b>1/1のラプターを2体召喚する。)
#[UNG_079][フローズン・クラッシャー]([x]このミニオンは攻撃した後、<b>凍結</b>する。)
#[UNG_082][サンダーリザード]([x]<b>雄叫び:</b>前のターンに手札からエレメンタルを使用していた場合<b>適応</b>する。)
#[UNG_083][デビルサウルスの卵]([x]<b>断末魔:</b>5/5のデビルサウルスを1体召喚する。)
#[UNG_084][ファイアプルーム・フェニックス](<b>雄叫び:</b>2ダメージを与える。)
#[UNG_085][エメラルドの巣の女王]([x]自分のミニオン全てのコストが（2）増える。)
