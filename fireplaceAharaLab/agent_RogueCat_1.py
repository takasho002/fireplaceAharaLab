def RogueCat_condition_deathrattle(game,ID):
	...
	if 'AT_' in ID:
		if ID == 'AT_036':
			...
			myCondition.append(['deathrattle','haveDragon(game)', 'damageAll'])
			#チルモー : [x]<b>挑発</b>、<b>断末魔:</b>自分の手札にドラゴンがいる場合、全てのミニオンに3ダメージを与える。
		elif ID == 'AT_128':
			myCondition.append(['deathrattle','', 'backCardHand'])
			#骸骨騎士 : [x]<b>断末魔:</b> 各プレイヤーのデッキのミニオンを1枚ずつ表示する。自分のミニオンの方がコストが高い場合、このミニオンを自分の手札に戻す。
	elif 'BOT_' in ID:
		if ID == 'BOT_031':
			myCondition.append(['deathrattle','', 'damage'])
			...
			myCondition.append(['deathrattle','', 'help'])
			...
			myCondition.append(['deathrattle','heHasMinion(game)', 'damage'])
			#ブーマーロボ : <b>断末魔:</b>ランダムな敵のミニオン1体に__4ダメージを与える。
		elif ID == 'BOT_700':
			myCondition.append(['deathrattle','', 'summon'])
			#チョッキンガー : <b>超電磁</b>、<b>木霊</b><b>断末魔:</b>1/1の「マイクロロボ」を2体召喚する。
	elif ID == 'BRM_027':
		myCondition.append(['deathrattle','', 'changeHero'])
		...
		if ID == 'BT_008':
			...
			myCondition.append(['deathrattle','', 'addCardDeck'])
		...
		if ID == 'CFM_095':
			myCondition.append(['deathrattle','', 'addCardHisDeck'])
			#穴掘りイタチ : [x]<b>断末魔:</b> このミニオンを相手のデッキに混ぜる。
		elif ID == 'CFM_120':
			myCondition.append(['deathrattle','', 'restoreBoth'])
			...
			myCondition.append(['deathrattle','', 'damageSelf'])
		...
		if ID == 'DAL_088':
			...
			myCondition.append(['deathrattle','card.atk>=4', 'summon'])
			#神出鬼没の怪人 : [x]<b>断末魔:</b>このミニオンの攻撃力が4以上の場合__再度召喚する。
		elif ID == 'DAL_775':
			myCondition.append(['deathrattle','', 'damageAll'])
		...
		if ID == 'DRG_036':
			...
			myCondition.append(['deathrattle','haveDragon(game)', 'help'])
			#美味しいマロバルーン : <b>断末魔:</b>自分の手札のドラゴン1体に__+2/+2を付与する。
		elif ID == 'DRG_071':
			myCondition.append(['deathrattle','', 'addSmallCardHisDeck'])
		...
		if ID == 'EX1_012':
			...
			myCondition.append(['deathrattle','', 'getMinion'])
			...
			myCondition.append(['deathrattle','', 'summonHisMion'])
			#魔獣 : [x]<b>断末魔:</b> 3/3のフィンクル・アインホルンを1体敵の陣地に召喚する。
	elif 'FP1_' in ID:
		if ID == 'FP1_001':
			myCondition.append(['deathrattle','myHeroMaxHealth>myHeroHealth', 'restore'])
			...
			myCondition.append(['deathrattle','', 'summonHisMinion'])
			...
			myCondition.append(['','haveDeathrattle(game)', ''])
			#バロン・リーヴェンデア : [x]味方のミニオンの__<b>断末魔</b>は2回発動する。
	elif 'GIL_' in ID:
		if ID == 'GIL_118':
			myCondition.append(['deathrattle','', 'restore'])
		...
		if ID == 'GVG_076':
			...
			myCondition.append(['deathrattle','heHasMinion(game)', 'help'])
		...
		if ID == 'LOE_012':
			...
			myCondition.append(['deathrattle','haveMinion(game)', 'help'])
		...
		if ID == 'LOOT_144':
			myCondition.append(['deathrattle','', 'addCardHisHand'])
			...
			myCondition.append(['deathrattle','haveMinion(game)', 'summon'])
		...
		if ID == 'OG_072':
			myCondition.append(['drawCard','', 'deathrattle'])
			...
			myCondition.append(['deathrattle','haveDragon(game)', 'playCard'])
		...
		if ID == 'TRL_074':
			...
			myCondition.append(['deathrattle','haveBeast(game)', 'help'])
		...
		if ID == 'ULD_174':
			...
			myCondition.append(['deathrattle','heHasMinion(game)', 'backCardHisHand'])
		...
		if ID == 'UNG_010':
			...
			myCondition.append(['deathrattle','', 'asleep'])
